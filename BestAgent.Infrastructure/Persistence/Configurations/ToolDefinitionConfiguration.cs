...
public class ToolDefinitionConfiguration : IEntityTypeConfiguration<ToolDefinition>
{
    public void Configure(EntityTypeBuilder<ToolDefinition> builder)
    {
        ...
        builder.Property(x => x.ExecutionKind).HasColumnName("execution_kind").HasMaxLength(32);
        builder.Property(x => x.ExecutionBinding).HasColumnName("execution_binding").HasColumnType("jsonb");
        ...
        builder.Property(x => x.CallbackSecret).HasColumnName("callback_secret").HasMaxLength(512);
        ...
        builder.Property(x => x.ParameterPolicy).HasColumnName("parameter_policy").HasColumnType("jsonb");
