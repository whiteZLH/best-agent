...
public class OpenAiCompatibleModelGatewayTests
{
    ...
    [Fact]
    public async Task GenerateTextAsync_ShouldReadChoiceLevelReasoningSummary_WhenMessageDoesNotIncludeIt()
    {
        using var httpClient = new HttpClient(new StubHttpMessageHandler(_ =>
            new HttpResponseMessage(HttpStatusCode.OK)
            {
        ...
        Assert.Equal("Choice-level reasoning.", result.ReasoningSummary);
    }

    [Fact]
    public async Task GenerateTextAsync_ShouldReadResponseIdAliases_WhenPrimaryIdIsMissing()
    {
        using var httpClient = new HttpClient(new StubHttpMessageHandler(_ =>
            new HttpResponseMessage(HttpStatusCode.OK)
            {
    ...
    [Fact]
    public async Task GenerateTextAsync_ShouldReadRequestIdAlias_WhenResponseIdAndPrimaryIdAreMissing()
    {
        using var httpClient = new HttpClient(new StubHttpMessageHandler(_ =>
            new HttpResponseMessage(HttpStatusCode.OK)
            {
        ...
        Assert.Equal("req_123", result.ResponseId);
    }
    ...
    public async Task GenerateTextAsync_ShouldReadUsageAliases_WhenGatewayReturnsInputAndOutputTokens()
    {
        ...
        Assert.Equal(21, result.TotalTokens);
    }
    ...
    public async Task GenerateTextAsync_ShouldExtractMessageRefusal_WhenContentIsMissing()
    {
        ...
        Assert.Equal("I can't help with that request.", result.Output);
    }

    [Fact]
    public async Task GenerateTextAsync_ShouldExtractChoiceLevelRefusal_WhenMessageContentAndRefusalAreMissing()
    {
        using var httpClient = new HttpClient(new StubHttpMessageHandler(_ =>
            new HttpResponseMessage(HttpStatusCode.OK)
            {
        ...
        Assert.Equal("I can't comply with that request.", result.Output);
    }
    ...
    [Fact]
    public async Task GenerateTextAsync_ShouldExtractChoiceLevelText_WhenMessageObjectIsMissing()
    {
        using var httpClient = new HttpClient(new StubHttpMessageHandler(_ =>
            new HttpResponseMessage(HttpStatusCode.OK)
            {
    ...
    [Fact]
    public async Task GenerateTextAsync_ShouldExtractChoiceLevelContent_WhenMessageObjectIsMissing()
    {
        using var httpClient = new HttpClient(new StubHttpMessageHandler(_ =>
            new HttpResponseMessage(HttpStatusCode.OK)
            {
    ...
    [Fact]
    public async Task GenerateTextAsync_ShouldExtractMessageOutputText_WhenContentIsMissing()
    {
        using var httpClient = new HttpClient(new StubHttpMessageHandler(_ =>
            new HttpResponseMessage(HttpStatusCode.OK)
            {
    ...
    [Fact]
    public async Task GenerateTextAsync_ShouldExtractChoiceLevelOutputText_WhenMessageObjectIsMissing()
    {
        using var httpClient = new HttpClient(new StubHttpMessageHandler(_ =>
            new HttpResponseMessage(HttpStatusCode.OK)
            {
    ...
    [Fact]
    public async Task GenerateTextAsync_ShouldExtractChoiceLevelOutputText_WhenMessageContentIsMissing()
    {
        using var httpClient = new HttpClient(new StubHttpMessageHandler(_ =>
            new HttpResponseMessage(HttpStatusCode.OK)
            {
                      ...
                      "choices": [
                        {
                          "message": {
                            "reasoning_summary": [
                              {
                                "text": {
                                  "value": "Need structured reasoning."
                                }
                              }
                            ],
                            "content": "{\"action\":\"respond\",\"response\":\"hello\"}"
    ...
    public async Task GenerateTextAsync_ShouldRejectMessagesWithoutContentOrContentParts()
    {
        ...
        Assert.Equal("Model messages must include content, content parts, or tool calls.", exception.Message);
    }

    [Fact]
    public async Task GenerateTextAsync_ShouldRejectExplicitEmptyMessages()
    {
        using var httpClient = new HttpClient(new StubHttpMessageHandler(_ =>
            new HttpResponseMessage(HttpStatusCode.OK)
            {
        ...
        Assert.Equal("Model messages must include at least one message.", exception.Message);
    }

    [Fact]
    public async Task GenerateTextAsync_ShouldRejectExplicitMessagesWhenAnyMessageIsInvalid()
    {
        using var httpClient = new HttpClient(new StubHttpMessageHandler(_ =>
            new HttpResponseMessage(HttpStatusCode.OK)
            {
    ...
    [Fact]
    public async Task GenerateTextAsync_ShouldRejectBlankOutputSchemaWhenExplicitlyProvided()
    {
        using var httpClient = new HttpClient(new StubHttpMessageHandler(_ =>
            new HttpResponseMessage(HttpStatusCode.OK)
            {
        ...
        Assert.Equal("Model output schema must be provided when output mode is json_schema.", exception.Message);
    }
    ...
    [Fact]
    public async Task GenerateTextAsync_ShouldRejectBlankOutputModeWhenExplicitlyProvided()
    {
        using var httpClient = new HttpClient(new StubHttpMessageHandler(_ =>
            new HttpResponseMessage(HttpStatusCode.OK)
            {
        ...
        Assert.Equal("Model output mode must not be blank when provided.", exception.Message);
    }
    ...
    [Fact]
    public async Task GenerateTextAsync_ShouldRejectExplicitEmptyTools()
    {
        using var httpClient = new HttpClient(new StubHttpMessageHandler(_ =>
            new HttpResponseMessage(HttpStatusCode.OK)
            {
    ...
    [Fact]
    public async Task GenerateTextAsync_ShouldRejectDuplicateToolNames()
    {
        using var httpClient = new HttpClient(new StubHttpMessageHandler(_ =>
            new HttpResponseMessage(HttpStatusCode.OK)
            {
        ...
        var exception = await Assert.ThrowsAsync<InvalidOperationException>(() =>
            gateway.GenerateTextAsync(
                new GenerateTextRequest(
                    ...
                    Tools:
                    [
                        new GenerateTextToolDefinition("weather", "Get weather", "{\"type\":\"object\"}"),
                        new GenerateTextToolDefinition(" Weather ", "Duplicate weather", "{\"type\":\"object\"}")
                    ]),
                CancellationToken.None));
    ...
    [Fact]
    public async Task GenerateTextAsync_ShouldNormalizeChoiceLevelNativeToolCallResponse_WhenMessageObjectIsMissing()
    {
        using var httpClient = new HttpClient(new StubHttpMessageHandler(_ =>
            new HttpResponseMessage(HttpStatusCode.OK)
            {
    ...
    [Fact]
    public async Task GenerateTextAsync_ShouldNormalizeChoiceLevelLegacyFunctionCallResponse_WhenMessageObjectIsMissing()
    {
        using var httpClient = new HttpClient(new StubHttpMessageHandler(_ =>
            new HttpResponseMessage(HttpStatusCode.OK)
            {
    ...
    [Fact]
    public async Task GenerateTextAsync_ShouldNormalizeLegacyFunctionCallResponse()
    {
        using var httpClient = new HttpClient(new StubHttpMessageHandler(_ =>
            new HttpResponseMessage(HttpStatusCode.OK)
            {
    ...
    [Fact]
    public async Task GenerateTextAsync_ShouldNormalizeLegacyFunctionCallResponse_WhenArgumentsAreReturnedAsObject()
    {
        using var httpClient = new HttpClient(new StubHttpMessageHandler(_ =>
            new HttpResponseMessage(HttpStatusCode.OK)
            {
    ...
    [Fact]
    public async Task GenerateTextAsync_ShouldInferToolCallFinishReason_WhenChoiceLevelNativeToolCallsAreReturnedWithoutMessageObject()
    {
        using var httpClient = new HttpClient(new StubHttpMessageHandler(_ =>
            new HttpResponseMessage(HttpStatusCode.OK)
            {
    ...
    [Fact]
    public async Task GenerateTextAsync_ShouldNormalizeMaxOutputTokensFinishReason()
    {
        using var httpClient = new HttpClient(new StubHttpMessageHandler(_ =>
            new HttpResponseMessage(HttpStatusCode.OK)
            {
    ...
    [Fact]
    public async Task GenerateTextAsync_ShouldNormalizeAdditionalCamelCaseFinishReasonValues()
    {
        using var contentFilteredHttpClient = new HttpClient(new StubHttpMessageHandler(_ =>
            new HttpResponseMessage(HttpStatusCode.OK)
            {
                Content = new StringContent(
                    """
        ...
        var contentFilteredGateway = new OpenAiCompatibleModelGateway(
            contentFilteredHttpClient,
            new OpenAiOptions
            {
                BaseUrl = "https://example.com/v1/",
                ApiKey = "test-key",
        ...
        var contentFilteredResult = await contentFilteredGateway.GenerateTextAsync(
            new GenerateTextRequest(string.Empty, "You are helpful.", "Hello"),
            CancellationToken.None);
        ...
        using var functionCallHttpClient = new HttpClient(new StubHttpMessageHandler(_ =>
            new HttpResponseMessage(HttpStatusCode.OK)
            {
                Content = new StringContent(
                    """
        ...
        var functionCallGateway = new OpenAiCompatibleModelGateway(
            functionCallHttpClient,
            new OpenAiOptions
            {
                BaseUrl = "https://example.com/v1/",
                ApiKey = "test-key",
        ...
        var functionCallResult = await functionCallGateway.GenerateTextAsync(
            new GenerateTextRequest(string.Empty, "You are helpful.", "Hello"),
            CancellationToken.None);

        Assert.Equal(GenerateTextFinishReasons.ToolCall, functionCallResult.FinishReason);
    }

    [Fact]
    public async Task GenerateTextAsync_ShouldNormalizeSingularToolCallFinishReason()
    {
        using var httpClient = new HttpClient(new StubHttpMessageHandler(_ =>
            new HttpResponseMessage(HttpStatusCode.OK)
            {
    ...
    [Fact]
    public async Task GenerateTextAsync_ShouldExtractNestedTextValueContentSegments()
    {
        using var httpClient = new HttpClient(new StubHttpMessageHandler(_ =>
            new HttpResponseMessage(HttpStatusCode.OK)
            {
    ...
    [Fact]
    public async Task GenerateTextAsync_ShouldRejectNativeToolCallsItemsThatAreNotObjects()
    {
        using var httpClient = new HttpClient(new StubHttpMessageHandler(_ =>
            new HttpResponseMessage(HttpStatusCode.OK)
            {
        ...
        Assert.Equal("Model gateway returned a native tool_calls item that is not an object.", exception.Message);
    }
